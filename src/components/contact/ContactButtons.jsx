...
export default function ContactButtons() {
  ...
  const buttons = [
    {
      text: t('btnTwo'),
      link: 'https://www.linkedin.com/in/huda-mabkhoot/',
      img: (
    ...
    {
      text: t('btnThree'),
      link: 'https://wa.me/+966530426490',
      img: (
      <svg stroke="currentColor" fill="currentColor" strokeWidth="0" t="1569683925316" viewBox="0 0 1024 1024" version="1.1" height="1.5em" width="1.5em" xmlns="http://www.w3.org/2000/svg">
        <defs></defs>
            ...
            locale === 'ar'
              ? (
                ...
                <span className="text-main-purple">!</span>
                  {t('title')} <span className="text-main-purple">لنعمل معاً</span>
                </>
              )
              : t.rich('title', {
